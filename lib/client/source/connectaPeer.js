 ...
 */
ConnectaPeer.prototype.sendMessage = function(type,msg)
{
    if(this._data && this._data.readyState == "open")
    {
        this._data.send(MessageType.MESSAGE+JSON.stringify({ev:type,data:msg}));
    }
}
...
ConnectaPeer.prototype.dispose = function()
{
    ...
    if(scope._data)
    {
        scope._data.onclose   = null;
        scope._data.onmessage = null;
        scope._data.onerror   = null;
        scope._data.onopen    = null;
        scope._data.close();
    }
    if(scope._conn)
    {
...
if(typeof module != 'undefined')
{
    if(module.exports)
    {
        module.exports.ConnectaPeer = ConnectaPeer;
    }
}